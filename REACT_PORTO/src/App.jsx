    ...
    <div className="hero grid md:grid-cols-2 items-center pt-20 xl:gap-10 gap-8 grid-cols-1">
      <div className="animate__animated animate__fadeInUp animate__delay-3s order-2 md:order-1">
        ...
        <div className="flex items-center sm:gap-4 gap-3">
          <a href="/CV_Abdur Rochman Azis..pdf" download="CV_Abdur Rochman Azis..pdf" className="bg-emerald-600 px-6 py-4 rounded-full hover:bg-emerald-500 transition-all duration-300 shadow-lg shadow-emerald-700/30 flex items-center gap-2 text-white font-medium group">
